...
DEFINE_string(algorithm_config_file, "","configure for aglorithtm.");
...
//   rovio_config_template_file += "/rovio_default_config.info";
  CHECK(common::fileExists(FLAGS_algorithm_config_file))
      << "ROVIO configuration template file does not exist: "
      << FLAGS_algorithm_config_file;
  return FLAGS_algorithm_config_file;
}
}  // namespace
