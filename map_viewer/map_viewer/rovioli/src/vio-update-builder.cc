...
DEFINE_bool(publish_web_vis, false, "publish msg for web visualization");
namespace rovioli {
        ...
        *it_rovio_estimate_after_nframe;
        ...
        if (found_exact_match) {
            ...
            if (rovio_estimate_before_nframe->has_T_G_M) {
                ...
                aslam::Transformation T_G_I=vio_update->T_G_M*T_M_I;
                vio_update->vinode.get_T_M_I()=T_G_I;
                vio_update->T_G_M.setIdentity();
            }
        } else {
