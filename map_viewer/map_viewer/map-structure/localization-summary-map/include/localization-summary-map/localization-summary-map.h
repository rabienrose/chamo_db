...
class LocalizationSummaryMap {
 public:
  ...
  int getLandMarkIndex(const vi_map::LandmarkId& landmark_id) const{
      std::unordered_map<vi_map::LandmarkId, int>::const_iterator it = landmark_id_to_landmark_index_.find(landmark_id);
